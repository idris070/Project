...
math3d::Vector3f math3d::Vector3f::Cross(const Vector3f& v) const
{
...
math3d::Vector3f& math3d::Vector3f::Normalize()
{
...
void math3d::Vector3f::Rotate(float Angle, const Vector3f& Axe)
{
...
void Matrix4f::InitCameraTransform(const math3d::Vector3f& Target, const math3d::Vector3f& Up)
{
	math3d::Vector3f N = Target;
	N.Normalize();
	math3d::Vector3f U = Up;
	U = U.Cross(N);
	U.Normalize();
	math3d::Vector3f V = N.Cross(U);
...
Quaternion operator*(const Quaternion& q, const math3d::Vector3f& v)
{
...
math3d::Vector3f Quaternion::ToDegrees()
{
	float f[3];
